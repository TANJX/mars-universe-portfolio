  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-[600px] flex-col px-6 py-24 sm:py-32">
      ...
      <section className="space-y-10 text-[17px] leading-[1.65] text-foreground">
        <div>
          <h1 className="text-[28px] font-medium tracking-tight">Mars Tan</h1>
        ...
        <p>
          ...
          systems behind them, from design systems as infrastructure to workflow
          tooling that helps teams build and ship better products.
        </p>
      ...
      <nav className="mt-16 flex flex-wrap gap-x-6 gap-y-2 text-muted">
        ...
        <a href="https://github.com/marstanjx" target="_blank" rel="noreferrer">
          GitHub
        </a>
